package com.projeto.barbearia._utils;
...
public class TransformerTuple<T> {

    private final Tuple tuple;

    private final Class<T> resultClass;

    public static <T> T transformer(Tuple tuple, Class<T> classe){
        return new TransformerTuple<>(tuple, classe).transformTuple();
    }

    private TransformerTuple(Tuple tuple, Class<T> classe) {
        this.tuple = tuple;
        this.resultClass = classe;
    }

    private T transformTuple() {
    ...
    private T transformTuple(Object[] tuple, String[] aliases) {
                ...
                if(beanSubClass.containsKey(identificadorAtributo)){
                    ...
                    if(bean.instanciaObject == null){
                        ...
                        PropertyAccessStrategyFieldImpl.INSTANCE
                                .buildPropertyAccess(lastReference.getClass(), bean.nomeAtributo, false)
                                .getSetter()
                                .set(lastReference, bean.instanciaObject);
                    }
